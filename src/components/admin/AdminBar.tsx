...
export function AdminBar({ editHref, editLabel, extraLinks }: Props) {
  return (
    <nav
      ...
      data-admin-bar=""
    >
      <div className="flex max-w-[calc(100vw-1.5rem)] flex-wrap items-center gap-0.5 rounded-full border border-border bg-white/95 p-1 shadow-lg backdrop-blur-md">
