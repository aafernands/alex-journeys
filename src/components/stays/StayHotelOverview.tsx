...
export function StayHotelOverview({
  ...
  return (
    <main className="safe-bottom-page bg-bg md:pb-16">
      ...
      <div className="safe-bottom-bar fixed inset-x-0 bottom-0 z-40 border-t border-line bg-white/95 px-3 pt-3 shadow-[0_-8px_24px_rgba(0,0,0,0.08)] backdrop-blur md:hidden">
