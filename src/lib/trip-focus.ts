 ...
 */
export const TRIP_FOCUS_BOOT = `(function(){try{var p=location.pathname||"/";if(p.length>1&&p.charAt(p.length-1)==="/")p=p.slice(0,-1);var q=new URLSearchParams(location.search);var focus=/^\\/(stays|flights|experiences)(\\/|$)/.test(p);if(!focus&&p==="/out"&&q.get("from")==="trip")focus=true;if(!focus&&p==="${PLAN_A_TRIP_PATH}")focus=true;if(focus)document.documentElement.classList.add("trip-focus");}catch(e){}})();`;
